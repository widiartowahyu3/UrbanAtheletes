@extends('layouts/main', ['title' => 'Edit Karyawan', 'side' => 'karyawan'])
...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0">Edit Nama karyawan</h1>
      </div><!-- /.col -->
    ...
    <div class="row">
      <div class="col-sm-5">
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-lg-8">
                    <form action="{{ route('karyawan.update',$karyawans3->id) }}" method="POST">
                        @method('put')
                            @csrf
                            <div class="mb-3">
                                <label>Nama karyawan</label>
                            <input type="text" class="form-control @error('nama_karyawan') is-invalid
                                @enderror" name="nama_karyawan" id="nama_karyawan" value="{{ old('nama_karyawan',$karyawans3->nama_karyawan) }}">
                            @error('nama_karyawan')
                            ...
                            <input type="text" class="form-control @error('nik') is-invalid
                                @enderror" name="nik" id="nik" value="{{ old('nik',$karyawans3->nik) }}">
                            @error('nik')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            </div>
                            <div class="mb-3">
                                ...
                                <select class="form-select" name="club_id" id="club_id" value="{{ $karyawans3->club }}">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" name="jenis_kelamin" id="jenis_kelamin" value="{{ $karyawans3->jenis_kelamin }}">
